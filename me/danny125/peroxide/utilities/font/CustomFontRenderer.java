package me.danny125.peroxide.utilities.font;
...
public class CustomFontRenderer extends CustomFont {
    protected CharData[] boldChars = new CharData[1024];
    protected CharData[] italicChars = new CharData[1024];
    protected CharData[] boldItalicChars = new CharData[1024];
	...
	public float drawCenteredStringWithShadow(String text, float x, float y, Color color) {
		return drawShadedString(text, x - getStringWidth(text) / 2, y, color);
	}
	...
	public float drawString(String text, double x, double y, Color gsColor, boolean shadow) {
		...
		if (color.getAlpha()<4) color= color; //fix this line to:do
